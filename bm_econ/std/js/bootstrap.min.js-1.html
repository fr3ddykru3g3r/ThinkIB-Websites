...
<head>
	...
	<title>Dashboard - ThinkIB students</title>
	<meta charset="utf-8">
  ...
  <link href="../../css/font-awesome-4.7.0/css/font-awesome.min-1.css" rel="stylesheet">
	...
	<link rel="stylesheet" href="../../css/std/dashboard.min.css?v=202305221900"><link rel="stylesheet" href="../../css/std-access.min-1.css?v=202305221900"><link rel="stylesheet" href="../../css/snippets.min-1.css?v=202305221900"><link rel="stylesheet" href="../../css/article.min-1.css?v=2023061230"><link rel="stylesheet" href="../../css/std/frontpage.min-1.css?v=202305221900"><link href="../../css/tablesorter/theme.blue.css" rel="stylesheet" media="screen"><link href="../../js/select2/css/select2.css" rel="stylesheet"><link rel="stylesheet" href="../../assets/css/ckeditor5-custom-1.css" type="text/css"><script src="../../js/localdates.min-1.js?v=202009290900"></script><script src="../../js/ifvisible.min-1.js"></script><script>ifvisible.setIdleDuration(300);</script><script>var tibSitename = "std";</script>
    <script>
        const SITE_TAG = "ib"
...
<body onunload="" class="student-access">
    ...
    <div class="wmap">
        <div class="layout-wrapper">
            <div class="container-fluid">
                ...
                <div class="pull-left">
                	<h1><a href="../../index.htm"><span style="font-size: .8em;">STUDENT PAGES AT THINKIB.NET</span></a></h1>
                    <p class="slogan hidden-phone"><span class="slogan"><em>InThinking</em> Subject Sites for teachers &amp; their classes</span></p>
                	<p class="hidden-phone"><em></em></p>
                </div>
	...
	<div class="layout-wrapper">
		<div id="container" class="container-fluid">
			<div id="content">
				<div class="row-fluid">
					<div id="left-column" class="span3"><div id="new-notifications"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i><span class="badge badge-important unread-msgs" style="display: none;">0</span></a><ul class="dropdown-menu"><div class="header"><h4 style="margin-bottom: 0;">Notifications<a class="mark-all-as-read disabled" href="#">Mark all as read</a></h4></div><div class="no-notifications"><p>No notifications in the last 30 days</p></div></ul></div><div id="subjects-assignments-switcher" class="pull-right btn-group"><a href="#panel-dashboard" data-toggle="tab" class="btn active"><i class="fa fa-dashboard"></i> Dashboard</a><a href="#panel-tasks" data-toggle="tab" class="btn "><i class="fa fa-pencil"></i> All tasks</a></div></div><!-- /#left-column-->
					<div id="main-column" class="span9"><hr style="margin-top: 50px;"><h3 class="text-center"><span class="gray">No student groups have been configured yet.</span><br>Go to the <a href="https://www.thinkib.net">teacher&apos;s site</a>, log in and set up your student groups.</h3><hr></div><!-- /#main-column -->
				</div>
			</div><!-- /#content -->
		</div>
	</div>
...
<input id="tzoffset" type="hidden" value="new">
	...
	<script src="../../js/jq-tablesorter/jquery.tablesorter%402.31.3.js"></script><script src="../../js/jq-tablesorter/jquery.tablesorter.widgets.js"></script><script src="../../js/jq-tablesorter/jquery.tablesorter.pager.js"></script><script src="../../js/jq-tablesorter/pager-custom-controls.js"></script><script type="text/javascript" src="../../js/std-access/std-comments-utils.min-1.js?v=202305221900"></script><script type="text/javascript" src="../../js/tib-quizzes-utils.min-1.js?v=20230810"></script><script type="text/javascript" src="../../js/std-access/std-assignments-utils.min-1.js?v=202305221900"></script><script type="text/javascript" src="../../js/std/std-dashboard.min.js?v=202305221900"></script><script type="text/javascript" src="../../js/std/std-task-utils.min-1.js?v=202305221900"></script><!-- MathJax only to render Math ML -->
...
<script src="../../js/jq-mark.js/jquery.mark.min-1.js"></script><script src="../../js/select2/js/select2.min.js"></script><script src="../../js/jq-tablesorter/jquery.tablesorter.widget-filter-formatter-select2.js"></script><script type="text/javascript">var studentId = ""</script><script src="../../js/header-circle.min-1.js?v=202305221900"></script><script type="text/javascript" src="../../js/cookies.min-1.js"></script>
...
if (! readCookie("displayCookieConsent") && ! readCookie("y") ) {
    ...
    setTimeout(function() {
        $.ajax({
            ...
            dataType: "script",
            success: function () {
                cookieChoices.showCookieConsentBar(cookieMSG, 'close', 'Read more', "std/legal#cookies");
            }
        });
    }, 2000);
}
</script><script>var sessionUpdateSecs = 600;</script><script type="text/javascript" src="../../js/session-updater-1.js?v=20200831"></script>
	<script type="text/javascript">
